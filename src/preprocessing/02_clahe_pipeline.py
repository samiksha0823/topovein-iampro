...
# CONFIG
# ─────────────────────────────────────────
CSV_INDEX      = "results/dataset_index.csv"          # from 01_explore_dataset.py
OUTPUT_ROOT    = "results/preprocessed"               # where processed images are saved
LOG_FILE       = "results/02_clahe_log.txt"
